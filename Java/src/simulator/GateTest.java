...
class GateTest {
    ...
    void testEvaluateStateTableLookupNOT() throws InvalidNameException, InvalidGateException {
        ...
        expectedState = 1; // EXPECT AND(1, 1) = 1.
        assertEquals(expectedState, uut.getState());
        System.out.println("Passed NOT test.");
    }
    ...
    @Test
    void testEvaluateInputScanningAND() throws InvalidNameException, InvalidGateException {
        Gate inputA = new Gate("IN1", GateType.INPUT, 0);
        inputA.setState(1);
        ...
        uut.evaluateState(GateEvaluationMethod.INPUT_SCAN);
    ...
    @Test
    void testEvaluateInputScanningDFF() throws InvalidNameException, InvalidGateException {
        Gate inputA = new Gate("IN1", GateType.INPUT, 0);
        inputA.setState(1);
    ...
    @Test
    void testEvaluateInputScanningNOT() throws InvalidNameException, InvalidGateException {
        Gate inputA = new Gate("IN1", GateType.INPUT, 0);
        inputA.setState(1);
    ...
    @Test
    void testEvaluateInputScanningXOR() throws InvalidNameException, InvalidGateException {
        Gate inputA = new Gate("IN1", GateType.INPUT, 0);
        inputA.setState(1);
        ...
        int expectedState = 0;
        assertEquals(expectedState, uut.getState());
        System.out.println("Passed XOR test 1, XOR(1, 1) = 0.");
        ...
        expectedState = 1;
        assertEquals(expectedState, uut.getState());
        System.out.println("Passed XOR test, XOR(0, 1) = 1");
